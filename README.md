...
ratings, or the synthetic MNAR dataset's uniform-random (MCAR) test sample drawn over
all user-item pairs independently of exposure. Training-set metrics are never reported
as honest accuracy estimates.
